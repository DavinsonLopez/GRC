...
@section('content')
    <section class="stack">
        <article class="panel">
            ...
            {{-- Vulnerabilidad educativa (XSS): renderizado sin escape en campos de texto. --}}
        ...
        <article class="panel">
            ...
            {{-- Vulnerabilidad: formulario de comentarios sin token CSRF. --}}
        ...
        @foreach($comentarios as $comentario)
            <article class="card">
                ...
                {{-- Vulnerabilidad (XSS almacenado): salida de comentario sin escape. --}}
